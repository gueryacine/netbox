...
if settings.WEBHOOKS_ENABLED:
    _patterns += [url(r"^admin/webhook-backend-status/", include("django_rq.urls"))]

if settings.DEBUG:
    import debug_toolbar

    _patterns += [url(r"^__debug__/", include(debug_toolbar.urls))]

# Prepend BASE_PATH
urlpatterns = [url(r"^{}".format(settings.BASE_PATH), include(_patterns))]
