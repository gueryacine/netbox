...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(limit_choices_to={'model__in': ['consoleport', 'consoleserverport', 'interface', 'poweroutlet', 'powerport', 'frontport', 'rearport']}, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='contenttypes.ContentType'),
        ),
        migrations.AddField(
            model_name='cable',
        ...
        migrations.AlterUniqueTogether(
            name='device',
            unique_together={('virtual_chassis', 'vc_position'), ('rack', 'position', 'face')},
        ),
        migrations.AlterUniqueTogether(
