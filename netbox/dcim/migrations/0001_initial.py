    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateField(auto_now_add=True, null=True)),
                ('last_updated', models.DateTimeField(auto_now=True, null=True)),
                ('name', utilities.fields.NullableCharField(blank=True, max_length=64, null=True, unique=True)),
                ('serial', models.CharField(blank=True, max_length=50)),
                ('asset_tag', utilities.fields.NullableCharField(blank=True, max_length=50, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=64)),
                ('connection_status', models.NullBooleanField()),
                ('form_factor', models.PositiveSmallIntegerField(default=1200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated', models.DateTimeField(auto_now=True, null=True)),
                ('name', models.CharField(max_length=50)),
                ('facility_id', utilities.fields.NullableCharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.TextField(blank=True)),
                ('region', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sites', to='dcim.Region')),
