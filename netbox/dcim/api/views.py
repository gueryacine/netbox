...
class DeviceTypeViewSet(CustomFieldModelViewSet):
    queryset = DeviceType.objects.select_related("manufacturer").prefetch_related(
        "tags"
    )
...
class DeviceViewSet(CustomFieldModelViewSet):
    ...
    ).prefetch_related("primary_ip4__nat_outside", "primary_ip6__nat_outside", "tags")
...
class InterfaceViewSet(CableTraceMixin, ModelViewSet):
    ...
    ).prefetch_related("ip_addresses", "tags")
...
class DeviceBayViewSet(ModelViewSet):
    queryset = DeviceBay.objects.select_related("installed_device").prefetch_related(
        "tags"
    )
