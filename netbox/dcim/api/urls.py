...
router.register(
    r"console-server-port-templates", views.ConsoleServerPortTemplateViewSet
)
...
router.register(
    ...
    views.ConsoleConnectionViewSet,
    basename="consoleconnections",
)
router.register(
    r"power-connections", views.PowerConnectionViewSet, basename="powerconnections"
)
router.register(
...
# Miscellaneous
router.register(
    r"connected-device", views.ConnectedDeviceViewSet, basename="connected-device"
)
