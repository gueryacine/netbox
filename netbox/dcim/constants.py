...
RACK_WIDTH_19IN = 19
RACK_WIDTH_23IN = 23
RACK_WIDTH_CHOICES = ((RACK_WIDTH_19IN, "19 inches"), (RACK_WIDTH_23IN, "23 inches"))

# Rack faces
RACK_FACE_FRONT = 0
RACK_FACE_REAR = 1
RACK_FACE_CHOICES = [[RACK_FACE_FRONT, "Front"], [RACK_FACE_REAR, "Rear"]]
...
IFACE_FF_CHOICES = [
    [
        "Virtual interfaces",
        [[IFACE_FF_VIRTUAL, "Virtual"], [IFACE_FF_LAG, "Link Aggregation Group (LAG)"]],
    ],
    [
        "Ethernet (fixed)",
        [
    ...
    [
        "Cellular",
        [[IFACE_FF_GSM, "GSM"], [IFACE_FF_CDMA, "CDMA"], [IFACE_FF_LTE, "LTE"]],
    ],
    [
        "SONET",
        [
    ...
    ["Other", [[IFACE_FF_OTHER, "Other"]]],
]

VIRTUAL_IFACE_TYPES = [IFACE_FF_VIRTUAL, IFACE_FF_LAG]
...
ETHERNET_IFACE_TYPES = [
    IFACE_FF_100ME_FIXED, 
    IFACE_FF_1GE_FIXED, 
    IFACE_FF_10GE_FIXED, 
    IFACE_FF_10GE_CX4, 
    IFACE_FF_1GE_GBIC, 
    IFACE_FF_1GE_SFP, 
    IFACE_FF_10GE_SFP_PLUS, 
    IFACE_FF_10GE_XFP,
    IFACE_FF_10GE_XENPAK,
    IFACE_FF_10GE_X2,
    IFACE_FF_25GE_SFP28,
    IFACE_FF_40GE_QSFP_PLUS,
    IFACE_FF_100GE_CFP, 
    IFACE_FF_100GE_CFP2,
    IFACE_FF_200GE_CFP2,
    IFACE_FF_100GE_CFP4, 
    IFACE_FF_100GE_CPAK, 
    IFACE_FF_100GE_QSFP28, 
    IFACE_FF_200GE_QSFP56, 
    IFACE_FF_400GE_QSFP_DD,
]
...
PORT_TYPE_LSH = 2600
PORT_TYPE_CHOICES = [
    ["Copper", [[PORT_TYPE_8P8C, "8P8C"], [PORT_TYPE_110_PUNCH, "110 Punch"]]],
    [
        "Fiber Optic",
        [
            [PORT_TYPE_FC, "FC"],
