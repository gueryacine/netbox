...
class RackGroupTable(BaseTable):
    ...
    site = tables.LinkColumn(
        viewname="dcim:site", args=[Accessor("site.slug")], verbose_name="Site"
    )
...
class DeviceTypeTable(BaseTable):
    ...
    model = tables.LinkColumn(
        viewname="dcim:devicetype", args=[Accessor("pk")], verbose_name="Device Type"
    )
...
class DeviceTable(BaseTable):
    ...
    name = tables.TemplateColumn(
        order_by=("_nat1", "_nat2", "_nat3"), template_code=DEVICE_LINK
    )
    status = tables.TemplateColumn(template_code=STATUS_LABEL, verbose_name="Status")
    tenant = tables.TemplateColumn(template_code=COL_TENANT)
    site = tables.LinkColumn("dcim:site", args=[Accessor("site.slug")])
...
class CableTable(BaseTable):
    ...
    id = tables.LinkColumn(
        viewname="dcim:cable", args=[Accessor("pk")], verbose_name="ID"
    )
    ...
    termination_a = tables.Column(
        accessor=Accessor("termination_a"), orderable=False, verbose_name=""
    )
    ...
    termination_b = tables.Column(
        accessor=Accessor("termination_b"), orderable=False, verbose_name=""
    )
...
class InterfaceConnectionTable(BaseTable):
    ...
    description_a = tables.Column(
        accessor=Accessor("description"), verbose_name="Description"
    )
    ...
    description_b = tables.Column(
        accessor=Accessor("connected_endpoint.description"), verbose_name="Description"
    )
...
class InventoryItemTable(BaseTable):
    ...
    manufacturer = tables.Column(
        accessor=Accessor("manufacturer.name"), verbose_name="Manufacturer"
    )
