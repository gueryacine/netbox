...
urlpatterns = [
    ...
    url(
        r"^regions/import/$", views.RegionBulkImportView.as_view(), name="region_import"
    ),
    url(
        r"^regions/delete/$",
    ...
    url(
        r"^regions/(?P<pk>\d+)/edit/$",
        views.RegionEditView.as_view(),
        name="region_edit",
    ),
    url(
        r"^regions/(?P<pk>\d+)/changelog/$",
    ...
    url(
        r"^sites/(?P<slug>[\w-]+)/edit/$",
        views.SiteEditView.as_view(),
        name="site_edit",
    ),
    url(
        r"^sites/(?P<slug>[\w-]+)/delete/$",
        views.SiteDeleteView.as_view(),
        name="site_delete",
    ),
    url(
        r"^sites/(?P<slug>[\w-]+)/changelog/$",
        ObjectChangeLogView.as_view(),
        name="site_changelog",
        kwargs={"model": Site},
    ),
    url(
        r"^sites/(?P<object_id>\d+)/images/add/$",
    ...
    url(
        r"^rack-groups/add/$", views.RackGroupCreateView.as_view(), name="rackgroup_add"
    ),
    url(
        r"^rack-groups/import/$",
        views.RackGroupBulkImportView.as_view(),
        name="rackgroup_import",
    ),
    url(
        r"^rack-groups/delete/$",
        views.RackGroupBulkDeleteView.as_view(),
        name="rackgroup_bulk_delete",
    ),
    url(
        r"^rack-groups/(?P<pk>\d+)/edit/$",
        views.RackGroupEditView.as_view(),
        name="rackgroup_edit",
    ),
    url(
        r"^rack-groups/(?P<pk>\d+)/changelog/$",
        ObjectChangeLogView.as_view(),
    ...
    url(
        r"^rack-roles/(?P<pk>\d+)/edit/$",
        views.RackRoleEditView.as_view(),
        name="rackrole_edit",
    ),
    url(
        r"^rack-roles/(?P<pk>\d+)/changelog/$",
        ObjectChangeLogView.as_view(),
    ...
    url(
        r"^racks/delete/$", views.RackBulkDeleteView.as_view(), name="rack_bulk_delete"
    ),
    url(r"^racks/(?P<pk>\d+)/$", views.RackView.as_view(), name="rack"),
    url(r"^racks/(?P<pk>\d+)/edit/$", views.RackEditView.as_view(), name="rack_edit"),
    url(
        r"^racks/(?P<pk>\d+)/delete/$",
        views.RackDeleteView.as_view(),
        name="rack_delete",
    ),
    url(
        r"^racks/(?P<pk>\d+)/changelog/$",
        ObjectChangeLogView.as_view(),
        name="rack_changelog",
        kwargs={"model": Rack},
    ),
    url(
        r"^racks/(?P<rack>\d+)/reservations/add/$",
        views.RackReservationCreateView.as_view(),
        name="rack_add_reservation",
    ),
    url(
        r"^racks/(?P<object_id>\d+)/images/add/$",
        ImageAttachmentEditView.as_view(),
        name="rack_add_image",
        kwargs={"model": Rack},
    ),
    ...
    url(
        r"^device-types/add/$",
        views.DeviceTypeCreateView.as_view(),
        name="devicetype_add",
    ),
    url(
        r"^device-types/import/$",
    ...
    url(
        r"^platforms/(?P<slug>[\w-]+)/edit/$",
        views.PlatformEditView.as_view(),
        name="platform_edit",
    ),
    url(
        r"^platforms/(?P<slug>[\w-]+)/changelog/$",
        ObjectChangeLogView.as_view(),
    ...
    url(
        r"^devices/import/$", views.DeviceBulkImportView.as_view(), name="device_import"
    ),
    url(
        r"^devices/import/child-devices/$",
        views.ChildDeviceBulkImportView.as_view(),
        name="device_import_child",
    ),
    url(
        r"^devices/edit/$", views.DeviceBulkEditView.as_view(), name="device_bulk_edit"
    ),
    url(
        r"^devices/delete/$",
    ...
    url(
        r"^devices/(?P<pk>\d+)/edit/$",
        views.DeviceEditView.as_view(),
        name="device_edit",
    ),
    url(
        r"^devices/(?P<pk>\d+)/delete/$",
        views.DeviceDeleteView.as_view(),
        name="device_delete",
    ),
    url(
        r"^devices/(?P<pk>\d+)/config-context/$",
        views.DeviceConfigContextView.as_view(),
        name="device_configcontext",
    ),
    url(
        r"^devices/(?P<pk>\d+)/changelog/$",
        ObjectChangeLogView.as_view(),
        name="device_changelog",
        kwargs={"model": Device},
    ),
    url(
        r"^devices/(?P<pk>\d+)/inventory/$",
        views.DeviceInventoryView.as_view(),
        name="device_inventory",
    ),
    url(
        r"^devices/(?P<pk>\d+)/status/$",
        views.DeviceStatusView.as_view(),
        name="device_status",
    ),
    url(
        r"^devices/(?P<pk>\d+)/lldp-neighbors/$",
        views.DeviceLLDPNeighborsView.as_view(),
        name="device_lldp_neighbors",
    ),
    url(
        r"^devices/(?P<pk>\d+)/config/$",
        views.DeviceConfigView.as_view(),
        name="device_config",
    ),
    url(r"^devices/(?P<pk>\d+)/add-secret/$", secret_add, name="device_addsecret"),
    url(
        r"^devices/(?P<device>\d+)/services/assign/$",
        ServiceCreateView.as_view(),
        name="device_service_assign",
    ),
    url(
        r"^devices/(?P<pk>\d+)/port-template-groups/assign/$",
        views.DeviceAssignPortTemplatesGroupsView.as_view(),
        name="device_port_group_assign",
    ),
    url(
        r"^devices/(?P<object_id>\d+)/images/add/$",
        ImageAttachmentEditView.as_view(),
    ...
    url(
        r"^interfaces/(?P<pk>\d+)/edit/$",
        views.InterfaceEditView.as_view(),
        name="interface_edit",
    ),
    url(
        r"^interfaces/(?P<pk>\d+)/assign-vlans/$",
        views.InterfaceAssignVLANsView.as_view(),
        name="interface_assign_vlans",
    ),
    url(
        r"^interfaces/(?P<pk>\d+)/delete/$",
        views.InterfaceDeleteView.as_view(),
        name="interface_delete",
    ),
    url(
        r"^interfaces/(?P<pk>\d+)/changelog/$",
        ObjectChangeLogView.as_view(),
        name="interface_changelog",
        kwargs={"model": Interface},
    ),
    url(
        r"^interfaces/(?P<pk>\d+)/trace/$",
        views.CableTraceView.as_view(),
    ...
    url(
        r"^cables/delete/$",
        views.CableBulkDeleteView.as_view(),
        name="cable_bulk_delete",
    ),
    url(r"^cables/(?P<pk>\d+)/$", views.CableView.as_view(), name="cable"),
    url(
        r"^cables/(?P<pk>\d+)/edit/$", views.CableEditView.as_view(), name="cable_edit"
    ),
    url(
        r"^cables/(?P<pk>\d+)/delete/$",
        views.CableDeleteView.as_view(),
        name="cable_delete",
    ),
    url(
        r"^cables/(?P<pk>\d+)/changelog/$",
        ObjectChangeLogView.as_view(),
