...
class RackTestCase(TestCase):
    def setUp(self):
        ...
        self.role = {
            ...
            "Switch": DeviceRole.objects.create(name="Switch", slug="switch"),
            "Console Server": DeviceRole.objects.create(
                name="Console Server", slug="console-server"
            ),
            "PDU": DeviceRole.objects.create(name="PDU", slug="pdu"),
        }
...
class CableTestCase(TestCase):
    def setUp(self):
        ...
        self.rear_port = RearPort.objects.create(
            device=self.patch_pannel, name="R1", type=1000
        )
