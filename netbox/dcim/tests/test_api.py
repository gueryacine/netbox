...
class RegionTest(APITestCase):
    ...
    def test_create_region(self):
        ...
        data = {"name": "Test Region 4", "slug": "test-region-4"}
    ...
    def test_create_region_bulk(self):
        ...
        data = [
            {"name": "Test Region 4", "slug": "test-region-4"},
            {"name": "Test Region 5", "slug": "test-region-5"},
            {"name": "Test Region 6", "slug": "test-region-6"},
        ]
    ...
    def test_update_region(self):
        ...
        data = {"name": "Test Region X", "slug": "test-region-x"}
...
class SiteTest(APITestCase):
    ...
    def test_get_site_graphs(self):
        ...
        self.assertEqual(
            ...
            "http://example.com/graphs.py?site=test-site-1&foo=1",
        )
    ...
    def test_update_site(self):
        ...
        data = {"name": "Test Site X", "slug": "test-site-x", "region": self.region2.pk}
...
class RackRoleTest(APITestCase):
    ...
    def test_create_rackrole_bulk(self):
        ...
        data = [
            {"name": "Test Rack Role 4", "slug": "test-rack-role-4", "color": "ffff00"},
            {"name": "Test Rack Role 5", "slug": "test-rack-role-5", "color": "ffff00"},
            {"name": "Test Rack Role 6", "slug": "test-rack-role-6", "color": "ffff00"},
        ]
...
class RackTest(APITestCase):
    ...
    def test_list_racks_brief(self):
        ...
        self.assertEqual(
            sorted(response.data["results"][0]), ["display_name", "id", "name", "url"]
        )
...
class RackReservationTest(APITestCase):
    ...
    def test_get_rackreservation(self):
        ...
        url = reverse(
            "dcim-api:rackreservation-detail", kwargs={"pk": self.rackreservation1.pk}
        )
        response = self.client.get(url, **self.header)
...
class ManufacturerTest(APITestCase):
    ...
    def test_get_manufacturer(self):
        ...
        url = reverse(
            "dcim-api:manufacturer-detail", kwargs={"pk": self.manufacturer1.pk}
        )
        response = self.client.get(url, **self.header)
    ...
    def test_create_manufacturer(self):
        ...
        data = {"name": "Test Manufacturer 4", "slug": "test-manufacturer-4"}
    ...
    def test_create_manufacturer_bulk(self):
        ...
        data = [
            {"name": "Test Manufacturer 4", "slug": "test-manufacturer-4"},
            {"name": "Test Manufacturer 5", "slug": "test-manufacturer-5"},
            {"name": "Test Manufacturer 6", "slug": "test-manufacturer-6"},
        ]
    ...
    def test_update_manufacturer(self):
        ...
        data = {"name": "Test Manufacturer X", "slug": "test-manufacturer-x"}
...
class ConsolePortTemplateTest(APITestCase):
    ...
    def test_get_consoleporttemplate(self):
        ...
        url = reverse(
            "dcim-api:consoleporttemplate-detail",
    ...
    def test_create_consoleporttemplate(self):
        ...
        data = {"device_type": self.devicetype.pk, "name": "Test CP Template 4"}
    ...
    def test_create_consoleporttemplate_bulk(self):
        ...
        data = [
            {"device_type": self.devicetype.pk, "name": "Test CP Template 4"},
            {"device_type": self.devicetype.pk, "name": "Test CP Template 5"},
            {"device_type": self.devicetype.pk, "name": "Test CP Template 6"},
        ]
    ...
    def test_update_consoleporttemplate(self):
        ...
        data = {"device_type": self.devicetype.pk, "name": "Test CP Template X"}
...
class ConsoleServerPortTemplateTest(APITestCase):
    ...
    def test_get_consoleserverporttemplate(self):
        ...
        url = reverse(
            "dcim-api:consoleserverporttemplate-detail",
    ...
    def test_create_consoleserverporttemplate(self):
        ...
        data = {"device_type": self.devicetype.pk, "name": "Test CSP Template 4"}
    ...
    def test_create_consoleserverporttemplate_bulk(self):
        ...
        data = [
            {"device_type": self.devicetype.pk, "name": "Test CSP Template 4"},
            {"device_type": self.devicetype.pk, "name": "Test CSP Template 5"},
            {"device_type": self.devicetype.pk, "name": "Test CSP Template 6"},
        ]
    ...
    def test_update_consoleserverporttemplate(self):
        ...
        data = {"device_type": self.devicetype.pk, "name": "Test CSP Template X"}
...
class PowerPortTemplateTest(APITestCase):
    ...
    def test_get_powerporttemplate(self):
        ...
        url = reverse(
            "dcim-api:powerporttemplate-detail",
    ...
    def test_create_powerporttemplate(self):
        ...
        data = {"device_type": self.devicetype.pk, "name": "Test PP Template 4"}
    ...
    def test_create_powerporttemplate_bulk(self):
        ...
        data = [
            {"device_type": self.devicetype.pk, "name": "Test PP Template 4"},
            {"device_type": self.devicetype.pk, "name": "Test PP Template 5"},
            {"device_type": self.devicetype.pk, "name": "Test PP Template 6"},
        ]
    ...
    def test_update_powerporttemplate(self):
        ...
        data = {"device_type": self.devicetype.pk, "name": "Test PP Template X"}
...
class PowerOutletTemplateTest(APITestCase):
    ...
    def test_get_poweroutlettemplate(self):
        ...
        url = reverse(
            "dcim-api:poweroutlettemplate-detail",
    ...
    def test_create_poweroutlettemplate(self):
        ...
        data = {"device_type": self.devicetype.pk, "name": "Test PO Template 4"}
    ...
    def test_create_poweroutlettemplate_bulk(self):
        ...
        data = [
            {"device_type": self.devicetype.pk, "name": "Test PO Template 4"},
            {"device_type": self.devicetype.pk, "name": "Test PO Template 5"},
            {"device_type": self.devicetype.pk, "name": "Test PO Template 6"},
        ]
    ...
    def test_update_poweroutlettemplate(self):
        ...
        data = {"device_type": self.devicetype.pk, "name": "Test PO Template X"}
...
class InterfaceTemplateTest(APITestCase):
    ...
    def test_get_interfacetemplate(self):
        ...
        url = reverse(
            "dcim-api:interfacetemplate-detail",
    ...
    def test_create_interfacetemplate(self):
        ...
        data = {"device_type": self.devicetype.pk, "name": "Test Interface Template 4"}
    ...
    def test_create_interfacetemplate_bulk(self):
        ...
        data = [
            {"device_type": self.devicetype.pk, "name": "Test Interface Template 4"},
            {"device_type": self.devicetype.pk, "name": "Test Interface Template 5"},
            {"device_type": self.devicetype.pk, "name": "Test Interface Template 6"},
        ]
    ...
    def test_update_interfacetemplate(self):
        ...
        data = {"device_type": self.devicetype.pk, "name": "Test Interface Template X"}
...
class DeviceBayTemplateTest(APITestCase):
    ...
    def test_get_devicebaytemplate(self):
        ...
        url = reverse(
            "dcim-api:devicebaytemplate-detail",
    ...
    def test_create_devicebaytemplate(self):
        ...
        data = {"device_type": self.devicetype.pk, "name": "Test Device Bay Template 4"}
    ...
    def test_create_devicebaytemplate_bulk(self):
        ...
        data = [
            {"device_type": self.devicetype.pk, "name": "Test Device Bay Template 4"},
            {"device_type": self.devicetype.pk, "name": "Test Device Bay Template 5"},
            {"device_type": self.devicetype.pk, "name": "Test Device Bay Template 6"},
        ]
    ...
    def test_update_devicebaytemplate(self):
        ...
        data = {"device_type": self.devicetype.pk, "name": "Test Device Bay Template X"}
...
class PlatformTest(APITestCase):
    ...
    def test_create_platform(self):
        ...
        data = {"name": "Test Platform 4", "slug": "test-platform-4"}
    ...
    def test_create_platform_bulk(self):
        ...
        data = [
            {"name": "Test Platform 4", "slug": "test-platform-4"},
            {"name": "Test Platform 5", "slug": "test-platform-5"},
            {"name": "Test Platform 6", "slug": "test-platform-6"},
        ]
    ...
    def test_update_platform(self):
        ...
        data = {"name": "Test Platform X", "slug": "test-platform-x"}
...
class DeviceTest(APITestCase):
    ...
    def test_update_device(self):
        ...
        interface = Interface.objects.create(
            name="Test Interface 1", device=self.device1
        )
        ip4_address = IPAddress.objects.create(
            address=IPNetwork("192.0.2.1/24"), interface=interface
        )
        ip6_address = IPAddress.objects.create(
            address=IPNetwork("2001:db8::1/64"), interface=interface
        )
...
class ConsolePortTest(APITestCase):
    ...
    def test_get_consoleport(self):
        ...
        url = reverse(
            "dcim-api:consoleport-detail", kwargs={"pk": self.consoleport1.pk}
        )
        response = self.client.get(url, **self.header)
    ...
    def test_create_consoleport(self):
        ...
        data = {"device": self.device.pk, "name": "Test Console Port 4"}
    ...
    def test_create_consoleport_bulk(self):
        ...
        data = [
            {"device": self.device.pk, "name": "Test Console Port 4"},
            {"device": self.device.pk, "name": "Test Console Port 5"},
            {"device": self.device.pk, "name": "Test Console Port 6"},
        ]
    ...
    def test_update_consoleport(self):
        ...
        data = {"device": self.device.pk, "name": "Test Console Port X"}
...
class ConsoleServerPortTest(APITestCase):
    ...
    def test_get_consoleserverport(self):
        ...
        url = reverse(
            "dcim-api:consoleserverport-detail",
    ...
    def test_create_consoleserverport(self):
        ...
        data = {"device": self.device.pk, "name": "Test CS Port 4"}
    ...
    def test_create_consoleserverport_bulk(self):
        ...
        data = [
            {"device": self.device.pk, "name": "Test CS Port 4"},
            {"device": self.device.pk, "name": "Test CS Port 5"},
            {"device": self.device.pk, "name": "Test CS Port 6"},
        ]
    ...
    def test_update_consoleserverport(self):
        ...
        data = {"device": self.device.pk, "name": "Test CS Port X"}
...
class PowerPortTest(APITestCase):
    ...
    def test_create_powerport(self):
        ...
        data = {"device": self.device.pk, "name": "Test Power Port 4"}
    ...
    def test_create_powerport_bulk(self):
        ...
        data = [
            {"device": self.device.pk, "name": "Test Power Port 4"},
            {"device": self.device.pk, "name": "Test Power Port 5"},
            {"device": self.device.pk, "name": "Test Power Port 6"},
        ]
    ...
    def test_update_powerport(self):
        ...
        data = {"device": self.device.pk, "name": "Test Power Port X"}
...
class PowerOutletTest(APITestCase):
    ...
    def test_get_poweroutlet(self):
        ...
        url = reverse(
            "dcim-api:poweroutlet-detail", kwargs={"pk": self.poweroutlet1.pk}
        )
        response = self.client.get(url, **self.header)
    ...
    def test_create_poweroutlet(self):
        ...
        data = {"device": self.device.pk, "name": "Test Power Outlet 4"}
    ...
    def test_create_poweroutlet_bulk(self):
        ...
        data = [
            {"device": self.device.pk, "name": "Test Power Outlet 4"},
            {"device": self.device.pk, "name": "Test Power Outlet 5"},
            {"device": self.device.pk, "name": "Test Power Outlet 6"},
        ]
    ...
    def test_update_poweroutlet(self):
        ...
        data = {"device": self.device.pk, "name": "Test Power Outlet X"}
...
class InterfaceTest(APITestCase):
    ...
    def test_get_interface_graphs(self):
        ...
        self.assertEqual(
            response.data[0]["embed_url"],
            "http://example.com/graphs.py?interface=Test Interface 1&foo=1",
        )
    ...
    def test_create_interface(self):
        ...
        data = {"device": self.device.pk, "name": "Test Interface 4"}
    ...
    def test_create_interface_with_802_1q(self):
        ...
        self.assertEqual(
            [v["id"] for v in response.data["tagged_vlans"]], data["tagged_vlans"]
        )

    def test_create_interface_bulk(self):

        data = [
            {"device": self.device.pk, "name": "Test Interface 4"},
            {"device": self.device.pk, "name": "Test Interface 5"},
            {"device": self.device.pk, "name": "Test Interface 6"},
        ]
    ...
    def test_create_interface_802_1q_bulk(self):
        ...
        for i in range(0, 3):
            ...
            self.assertEqual(
                response.data[i]["untagged_vlan"]["id"], data[i]["untagged_vlan"]
            )
...
class DeviceBayTest(APITestCase):
    ...
    def test_list_devicebays_brief(self):
        ...
        self.assertEqual(
            sorted(response.data["results"][0]), ["device", "id", "name", "url"]
        )
    ...
    def test_create_devicebay_bulk(self):
        ...
        data = [
            {"device": self.parent_device.pk, "name": "Test Device Bay 4"},
            {"device": self.parent_device.pk, "name": "Test Device Bay 5"},
            {"device": self.parent_device.pk, "name": "Test Device Bay 6"},
        ]
...
class InventoryItemTest(APITestCase):
    ...
    def test_get_inventoryitem(self):
        ...
        url = reverse(
            "dcim-api:inventoryitem-detail", kwargs={"pk": self.inventoryitem1.pk}
        )
        response = self.client.get(url, **self.header)
...
class CableTest(APITestCase):
    ...
    def test_update_cable(self):
        ...
        data = {"label": "Test Cable X", "status": CONNECTION_STATUS_CONNECTED}
...
class VirtualChassisTest(APITestCase):
    ...
    def test_list_virtualchassis_brief(self):
        ...
        self.assertEqual(sorted(response.data["results"][0]), ["id", "master", "url"])

    def test_create_virtualchassis(self):

        data = {"master": self.device7.pk, "domain": "test-domain-3"}
        ...
        self.assertTrue(
            Device.objects.filter(pk=vc3.master.pk, virtual_chassis=vc3.pk).exists()
        )

    def test_create_virtualchassis_bulk(self):

        data = [
            {"master": self.device7.pk, "domain": "test-domain-3"},
            {"master": self.device8.pk, "domain": "test-domain-4"},
            {"master": self.device9.pk, "domain": "test-domain-5"},
        ]
    ...
    def test_update_virtualchassis(self):
        ...
        data = {"master": self.device2.pk, "domain": "test-domain-x"}
