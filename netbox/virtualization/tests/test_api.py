...
class ClusterTypeTest(APITestCase):
    ...
    def test_get_clustertype(self):
        ...
        url = reverse(
            "virtualization-api:clustertype-detail", kwargs={"pk": self.clustertype1.pk}
        )
    ...
    def test_create_clustertype(self):
        ...
        data = {"name": "Test Cluster Type 4", "slug": "test-cluster-type-4"}
    ...
    def test_create_clustertype_bulk(self):
        ...
        data = [
            {"name": "Test Cluster Type 4", "slug": "test-cluster-type-4"},
            {"name": "Test Cluster Type 5", "slug": "test-cluster-type-5"},
            {"name": "Test Cluster Type 6", "slug": "test-cluster-type-6"},
        ]
    ...
    def test_update_clustertype(self):
        ...
        data = {"name": "Test Cluster Type X", "slug": "test-cluster-type-x"}
...
class ClusterGroupTest(APITestCase):
    ...
    def test_get_clustergroup(self):
        ...
        url = reverse(
            "virtualization-api:clustergroup-detail",
    ...
    def test_create_clustergroup(self):
        ...
        data = {"name": "Test Cluster Group 4", "slug": "test-cluster-group-4"}
    ...
    def test_create_clustergroup_bulk(self):
        ...
        data = [
            {"name": "Test Cluster Group 4", "slug": "test-cluster-group-4"},
            {"name": "Test Cluster Group 5", "slug": "test-cluster-group-5"},
            {"name": "Test Cluster Group 6", "slug": "test-cluster-group-6"},
        ]
    ...
    def test_update_clustergroup(self):
        ...
        data = {"name": "Test Cluster Group X", "slug": "test-cluster-group-x"}
...
class ClusterTest(APITestCase):
    ...
    def test_get_cluster(self):
        ...
        url = reverse(
            "virtualization-api:cluster-detail", kwargs={"pk": self.cluster1.pk}
        )
        response = self.client.get(url, **self.header)
    ...
    def test_list_clusters_brief(self):
        ...
        self.assertEqual(sorted(response.data["results"][0]), ["id", "name", "url"])
...
class VirtualMachineTest(APITestCase):
    ...
    def test_get_virtualmachine(self):
        ...
        url = reverse(
            "virtualization-api:virtualmachine-detail",
    ...
    def test_create_virtualmachine(self):
        ...
        data = {"name": "Test Virtual Machine 4", "cluster": self.cluster1.pk}
    ...
    def test_create_virtualmachine_without_cluster(self):
        ...
        data = {"name": "Test Virtual Machine 4"}
    ...
    def test_create_virtualmachine_bulk(self):
        ...
        data = [
            {"name": "Test Virtual Machine 4", "cluster": self.cluster1.pk},
            {"name": "Test Virtual Machine 5", "cluster": self.cluster1.pk},
            {"name": "Test Virtual Machine 6", "cluster": self.cluster1.pk},
        ]
    ...
    def test_update_virtualmachine(self):
        ...
        interface = Interface.objects.create(
            name="Test Interface 1", virtual_machine=self.virtualmachine1
        )
...
class InterfaceTest(APITestCase):
    ...
    def test_get_interface(self):
        ...
        url = reverse(
            "virtualization-api:interface-detail", kwargs={"pk": self.interface1.pk}
        )
        response = self.client.get(url, **self.header)
    ...
    def test_create_interface(self):
        ...
        data = {"virtual_machine": self.virtualmachine.pk, "name": "Test Interface 4"}
    ...
    def test_create_interface_with_802_1q(self):
        ...
        self.assertEqual(Interface.objects.count(), 4)
        self.assertEqual(
            response.data["virtual_machine"]["id"], data["virtual_machine"]
        )
    ...
    def test_create_interface_bulk(self):
        ...
        data = [
            {"virtual_machine": self.virtualmachine.pk, "name": "Test Interface 4"},
            {"virtual_machine": self.virtualmachine.pk, "name": "Test Interface 5"},
            {"virtual_machine": self.virtualmachine.pk, "name": "Test Interface 6"},
        ]
    ...
    def test_update_interface(self):
        ...
        data = {"virtual_machine": self.virtualmachine.pk, "name": "Test Interface X"}
