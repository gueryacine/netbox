...
class ClusterFilter(CustomFieldFilterSet):
    ...
    group_id = django_filters.ModelMultipleChoiceFilter(
        queryset=ClusterGroup.objects.all(), label="Parent group (ID)"
    )
    ...
    type_id = django_filters.ModelMultipleChoiceFilter(
        queryset=ClusterType.objects.all(), label="Cluster type (ID)"
    )
...
class VirtualMachineFilter(CustomFieldFilterSet):
    ...
    status = django_filters.MultipleChoiceFilter(
        choices=VM_STATUS_CHOICES, null_value=None
    )
    ...
    cluster_id = django_filters.ModelMultipleChoiceFilter(
        queryset=Cluster.objects.all(), label="Cluster (ID)"
    )
    ...
    site_id = django_filters.ModelMultipleChoiceFilter(
        field_name="cluster__site", queryset=Site.objects.all(), label="Site (ID)"
    )
    site = django_filters.ModelMultipleChoiceFilter(
    ...
    role_id = django_filters.ModelMultipleChoiceFilter(
        queryset=DeviceRole.objects.all(), label="Role (ID)"
    )
