...
urlpatterns = [
    ...
    url(
        r"^clusters/import/$",
        views.ClusterBulkImportView.as_view(),
        name="cluster_import",
    ),
    url(
        r"^clusters/edit/$",
        views.ClusterBulkEditView.as_view(),
    ...
    url(
        r"^clusters/(?P<pk>\d+)/edit/$",
        views.ClusterEditView.as_view(),
        name="cluster_edit",
    ),
    url(
        r"^clusters/(?P<pk>\d+)/delete/$",
        views.ClusterDeleteView.as_view(),
        name="cluster_delete",
    ),
    url(
        r"^clusters/(?P<pk>\d+)/changelog/$",
        ObjectChangeLogView.as_view(),
        name="cluster_changelog",
        kwargs={"model": Cluster},
    ),
    url(
        r"^clusters/(?P<pk>\d+)/devices/add/$",
        views.ClusterAddDevicesView.as_view(),
        name="cluster_add_devices",
    ),
    url(
        r"^clusters/(?P<pk>\d+)/devices/remove/$",
