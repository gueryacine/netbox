...
class TagListView(ObjectListView):
    queryset = Tag.objects.annotate(items=Count("taggit_taggeditem_items")).order_by(
        "name"
    )
...
class ConfigContextView(View):
    def get(self, request, pk):
        ...
        return render(
            request, "extras/configcontext.html", {"configcontext": configcontext}
        )
...
class ReportListView(View):
    ...
    def get(self, request):
        ...
        return render(request, "extras/report_list.html", {"reports": ret})
...
class ReportView(View):
    ...
    def get(self, request, name):
        ...
        return render(
            request,
            "extras/report.html",
            {"report": report, "run_form": ConfirmationForm()},
        )
