...
class ExportTemplateTest(APITestCase):
    ...
    def test_get_exporttemplate(self):
        ...
        url = reverse(
            "extras-api:exporttemplate-detail", kwargs={"pk": self.exporttemplate1.pk}
        )
        response = self.client.get(url, **self.header)
...
class TagTest(APITestCase):
    ...
    def test_create_tag(self):
        ...
        data = {"name": "Test Tag 4", "slug": "test-tag-4"}
    ...
    def test_create_tag_bulk(self):
        ...
        data = [
            {"name": "Test Tag 4", "slug": "test-tag-4"},
            {"name": "Test Tag 5", "slug": "test-tag-5"},
            {"name": "Test Tag 6", "slug": "test-tag-6"},
        ]
    ...
    def test_update_tag(self):
        ...
        data = {"name": "Test Tag X", "slug": "test-tag-x"}
...
class ConfigContextTest(APITestCase):
    def setUp(self):
        ...
        self.configcontext1 = ConfigContext.objects.create(
            name="Test Config Context 1", weight=100, data={"foo": 123}
        )
        self.configcontext2 = ConfigContext.objects.create(
            name="Test Config Context 2", weight=200, data={"bar": 456}
        )
        self.configcontext3 = ConfigContext.objects.create(
            name="Test Config Context 3", weight=300, data={"baz": 789}
        )

    def test_get_configcontext(self):

        url = reverse(
            "extras-api:configcontext-detail", kwargs={"pk": self.configcontext1.pk}
        )
        response = self.client.get(url, **self.header)
    ...
    def test_create_configcontext(self):
        ...
        tenantgroup1 = TenantGroup.objects.create(
            name="Test Tenant Group 1", slug="test-tenant-group-1"
        )
        tenantgroup2 = TenantGroup.objects.create(
    ...
    def test_create_configcontext_bulk(self):
        ...
        data = [
            {"name": "Test Config Context 4", "data": {"more_foo": True}},
            {"name": "Test Config Context 5", "data": {"more_bar": False}},
            {"name": "Test Config Context 6", "data": {"more_baz": None}},
        ]
    ...
    def test_update_configcontext(self):
        ...
        self.assertEqual(
            sorted([r.pk for r in configcontext1.regions.all()]),
            sorted(data["regions"]),
        )
    ...
    def test_render_configcontext_for_object(self):
        ...
        device_type = DeviceType.objects.create(
            manufacturer=manufacturer, model="Test Device Type"
        )
        ...
        configcontext4 = ConfigContext(
            name="Test Config Context 4", data={"site_data": "ABC"}
        )
        configcontext4.save()
        ...
        configcontext5 = ConfigContext(
            name="Test Config Context 5", weight=2000, data={"foo": 999}
        )
        configcontext5.save()
        ...
        configcontext6 = ConfigContext(
            name="Test Config Context 6", weight=2000, data={"bar": 999}
        )
        configcontext6.save()
