...
class CustomFieldAPITest(APITestCase):
    ...
    def test_get_obj_with_custom_fields(self):
        ...
        self.assertEqual(response.data["name"], self.site.name)
        self.assertEqual(
            response.data["custom_fields"].get("magic_word"), CUSTOM_FIELD_VALUES[0][1]
        )
        self.assertEqual(
            response.data["custom_fields"].get("magic_number"),
            CUSTOM_FIELD_VALUES[1][1],
        )
        self.assertEqual(
            response.data["custom_fields"].get("is_magic"), CUSTOM_FIELD_VALUES[2][1]
        )
        self.assertEqual(
            response.data["custom_fields"].get("magic_date"), CUSTOM_FIELD_VALUES[3][1]
        )
        self.assertEqual(
            response.data["custom_fields"].get("magic_url"), CUSTOM_FIELD_VALUES[4][1]
        )
        self.assertEqual(
            response.data["custom_fields"].get("magic_choice"),
    ...
    def test_set_custom_field_text(self):
        ...
        data = {
            "name": "Test Site 1",
            "slug": "test-site-1",
            "custom_fields": {"magic_word": "Foo bar baz"},
        }
        ...
        self.assertEqual(
            response.data["custom_fields"].get("magic_word"),
    ...
    def test_set_custom_field_boolean(self):
        ...
        self.assertHttpStatus(response, status.HTTP_200_OK)
        self.assertEqual(
            response.data["custom_fields"].get("is_magic"),
    ...
    def test_set_custom_field_date(self):
        ...
        data = {
            "name": "Test Site 1",
            "slug": "test-site-1",
            "custom_fields": {"magic_date": "2017-04-25"},
        }
        ...
        self.assertHttpStatus(response, status.HTTP_200_OK)
        self.assertEqual(
            response.data["custom_fields"].get("magic_date"),
    ...
    def test_set_custom_field_url(self):
        ...
        data = {
            "name": "Test Site 1",
            "slug": "test-site-1",
            "custom_fields": {"magic_url": "http://example.com/2/"},
        }
        ...
        self.assertHttpStatus(response, status.HTTP_200_OK)
        self.assertEqual(
            response.data["custom_fields"].get("magic_url"),
    ...
    def test_set_custom_field_select(self):
        ...
        data = {
            "name": "Test Site 1",
            "slug": "test-site-1",
            "custom_fields": {"magic_choice": self.cf_select_choice2.pk},
        }
