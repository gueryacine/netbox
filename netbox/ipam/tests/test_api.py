...
class VRFTest(APITestCase):
    ...
    def test_list_vrfs_brief(self):
        ...
        self.assertEqual(
            sorted(response.data["results"][0]), ["id", "name", "rd", "url"]
        )
    ...
    def test_create_vrf_bulk(self):
        ...
        data = [
            {"name": "Test VRF 4", "rd": "65000:4"},
            {"name": "Test VRF 5", "rd": "65000:5"},
            {"name": "Test VRF 6", "rd": "65000:6"},
        ]
    ...
    def test_update_vrf(self):
        ...
        data = {"name": "Test VRF X", "rd": "65000:99"}
...
class RIRTest(APITestCase):
    ...
    def test_create_rir(self):
        ...
        data = {"name": "Test RIR 4", "slug": "test-rir-4"}
    ...
    def test_create_rir_bulk(self):
        ...
        data = [
            {"name": "Test RIR 4", "slug": "test-rir-4"},
            {"name": "Test RIR 5", "slug": "test-rir-5"},
            {"name": "Test RIR 6", "slug": "test-rir-6"},
        ]
    ...
    def test_update_rir(self):
        ...
        data = {"name": "Test RIR X", "slug": "test-rir-x"}
...
class AggregateTest(APITestCase):
    ...
    def test_list_aggregates_brief(self):
        ...
        self.assertEqual(
            sorted(response.data["results"][0]), ["family", "id", "prefix", "url"]
        )

    def test_create_aggregate(self):
        data = {"prefix": "192.0.2.0/24", "rir": self.rir1.pk}
    ...
    def test_create_aggregate_bulk(self):
        ...
        data = [
            {"prefix": "100.0.0.0/8", "rir": self.rir1.pk},
            {"prefix": "101.0.0.0/8", "rir": self.rir1.pk},
            {"prefix": "102.0.0.0/8", "rir": self.rir1.pk},
        ]
    ...
    def test_update_aggregate(self):
        ...
        data = {"prefix": "11.0.0.0/8", "rir": self.rir2.pk}
...
class RoleTest(APITestCase):
    ...
    def test_create_role(self):
        ...
        data = {"name": "Test Role 4", "slug": "test-role-4"}
    ...
    def test_create_role_bulk(self):
        ...
        data = [
            {"name": "Test Role 4", "slug": "test-role-4"},
            {"name": "Test Role 5", "slug": "test-role-5"},
            {"name": "Test Role 6", "slug": "test-role-6"},
        ]
    ...
    def test_update_role(self):
        ...
        data = {"name": "Test Role X", "slug": "test-role-x"}
...
class IPAddressTest(APITestCase):
    ...
    def test_list_ipaddresses_brief(self):
        ...
        self.assertEqual(
            sorted(response.data["results"][0]), ["address", "family", "id", "url"]
        )

    def test_create_ipaddress(self):

        data = {"address": "192.168.0.4/24", "vrf": self.vrf1.pk}
    ...
    def test_update_ipaddress(self):
        ...
        data = {"address": "192.168.0.99/24", "vrf": self.vrf1.pk}
...
class VLANGroupTest(APITestCase):
    ...
    def test_create_vlangroup(self):
        ...
        data = {"name": "Test VLAN Group 4", "slug": "test-vlan-group-4"}
    ...
    def test_create_vlangroup_bulk(self):
        ...
        data = [
            {"name": "Test VLAN Group 4", "slug": "test-vlan-group-4"},
            {"name": "Test VLAN Group 5", "slug": "test-vlan-group-5"},
            {"name": "Test VLAN Group 6", "slug": "test-vlan-group-6"},
        ]
    ...
    def test_update_vlangroup(self):
        ...
        data = {"name": "Test VLAN Group X", "slug": "test-vlan-group-x"}
...
class VLANTest(APITestCase):
    ...
    def test_create_vlan_bulk(self):
        ...
        data = [
            {"vid": 4, "name": "Test VLAN 4"},
            {"vid": 5, "name": "Test VLAN 5"},
            {"vid": 6, "name": "Test VLAN 6"},
        ]
...
class PortTemplateGroupTest(APITestCase):
    ...
    def test_get_porttemplategroup(self):
        ...
        url = reverse("ipam-api:porttemplategroup-detail", kwargs={"pk": self.porttemplategroup1.pk})
        response = self.client.get(url, **self.header)
    ...
    def test_list_porttemplategroups_brief(self):
        ...
        self.assertEqual(
            sorted(response.data["results"][0]), ["id", "name", "site", "slug"]
        )

    def test_create_porttemplategroup(self):

        data = {"name": "Test PortTemplate Group 4", "slug": "test-porttemplate-group-4"}
        ...
        porttemplategroup4 = PortTemplateGroup.objects.get(pk=response.data["id"])
    ...
    def test_update_porttemplategroup(self):
        ...
        data = {"name": "Test PortTemplate Group X", "slug": "test-porttemplate-group-x"}
        ...
        porttemplategroup1 = PortTemplateGroup.objects.get(pk=response.data["id"])
...
class PortTemplateTest(APITestCase):
    def setUp(self):
        ...
        self.porttemplate1 = PortTemplate.objects.create( name="Test porttemplate 1")
        self.porttemplate2 = PortTemplate.objects.create( name="Test porttemplate 2")
        self.porttemplate3 = PortTemplate.objects.create( name="Test porttemplate 3")

    def test_get_porttemplate(self):

        url = reverse("ipam-api:porttemplate-detail", kwargs={"pk": self.porttemplate1.pk})
        response = self.client.get(url, **self.header)
    ...
    def test_list_porttemplates_brief(self):
        ...
        self.assertEqual(
            sorted(response.data["results"][0]),
            ['created', 'custom_fields', 'description', 'display_name', 'group', 'id', 'last_updated', 'mode', 'name', 'role', 'site', 'status', 'tagged_vlans', 'tags', 'tenant', 'types', 'untagged_vlan']
        )
