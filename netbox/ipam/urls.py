...
urlpatterns = [
    ...
    # PortTemplateGroup
    path(r'port-template-groups/', views.PortTemplatesGroupListView.as_view(), name="port_template_group_list"),
    path(r'port-template-groups/add/', views.PortTemplatesGroupCreateView.as_view(), name="port_template_group_add"),
    path(r'port-template-groups/import/', views.PortTemplatesGroupBulkImportView.as_view(), name="port_template_group_import"),
    path(r'port-template-groups/delete/', views.PortTemplatesGroupBulkDeleteView.as_view(), name="port_template_group_bulk_delete"),
    path(r'port-template-groups/<int:pk>/edit/', views.PortTemplatesGroupEditView.as_view(), name="port_template_group_edit"),
    path(r'port-template-groups/<int:pk>/port-templates/', views.PortTemplatesGroupPortTemplatessView.as_view(), name="port_template_group_ports"),
    path(r'port-template-groups/<int:pk>/changelog/', ObjectChangeLogView.as_view(), name="port_template_group_changelog", kwargs={"model": PortTemplateGroup}),
    
    # PortTemplate
    path(r'port-templates/', views.PortTemplatesListView.as_view(), name="port_template_list"),
    path(r'port-templates/add/', views.PortTemplatesCreateView.as_view(), name="port_template_add"),
    path(r'port-templates/import/', views.PortTemplatesBulkImportView.as_view(), name="port_template_import"),
    path(r'port-templates/edit/', views.PortTemplatesBulkEditView.as_view(), name="port_template_bulk_edit"),
    path(r'port-templates/delete/', views.PortTemplatesBulkDeleteView.as_view(), name="port_template_bulk_delete"),
    path(r'port-templates/<int:pk>/', views.PortTemplatesView.as_view(), name="port_template"),
    path(r'port-templates/<int:pk>/members/', views.PortTemplatesMembersView.as_view(), name="port_template_members"),
    path(r'port-templates/<int:pk>/edit/', views.PortTemplatesEditView.as_view(), name="port_template_edit"),
    path(r'port-templates/<int:pk>/delete/', views.PortTemplatesDeleteView.as_view(), name="port_template_delete"),
    path(r'port-templates/<int:pk>/changelog/', ObjectChangeLogView.as_view(), name="port_template_changelog", kwargs={"model": PortTemplate}),
    path(r'port-templates/<int:pk>/assign-vlans/', views.PortTemplatesAssignVLANsView.as_view(), name="port_template_assign_vlans"),
