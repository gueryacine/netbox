...
urlpatterns = [
    ...
    url(
        r"^providers/(?P<slug>[\w-]+)/$", views.ProviderView.as_view(), name="provider"
    ),
    url(
        r"^providers/(?P<slug>[\w-]+)/edit/$",
        views.ProviderEditView.as_view(),
        name="provider_edit",
    ),
    url(
        r"^providers/(?P<slug>[\w-]+)/delete/$",
        views.ProviderDeleteView.as_view(),
        name="provider_delete",
    ),
    url(
        r"^providers/(?P<slug>[\w-]+)/changelog/$",
    ...
    url(
        r"^circuits/import/$",
        views.CircuitBulkImportView.as_view(),
        name="circuit_import",
    ),
    url(
        r"^circuits/edit/$",
        views.CircuitBulkEditView.as_view(),
