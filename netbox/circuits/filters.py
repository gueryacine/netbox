...
class CircuitFilter(CustomFieldFilterSet, django_filters.FilterSet):
    ...
    provider_id = django_filters.ModelMultipleChoiceFilter(
        queryset=Provider.objects.all(), label="Provider (ID)"
    )
    ...
    type_id = django_filters.ModelMultipleChoiceFilter(
        queryset=CircuitType.objects.all(), label="Circuit type (ID)"
    )
    ...
    site_id = django_filters.ModelMultipleChoiceFilter(
        field_name="terminations__site", queryset=Site.objects.all(), label="Site (ID)"
    )
    site = django_filters.ModelMultipleChoiceFilter(
...
class CircuitTerminationFilter(django_filters.FilterSet):
    ...
    circuit_id = django_filters.ModelMultipleChoiceFilter(
        queryset=Circuit.objects.all(), label="Circuit"
    )
    site_id = django_filters.ModelMultipleChoiceFilter(
