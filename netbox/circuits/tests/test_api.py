...
class ProviderTest(APITestCase):
    ...
    def test_get_provider_graphs(self):
        ...
        self.assertEqual(
            ...
            "http://example.com/graphs.py?provider=test-provider-1&foo=1",
        )
    ...
    def test_create_provider(self):
        ...
        data = {"name": "Test Provider 4", "slug": "test-provider-4"}
    ...
    def test_create_provider_bulk(self):
        ...
        data = [
            {"name": "Test Provider 4", "slug": "test-provider-4"},
            {"name": "Test Provider 5", "slug": "test-provider-5"},
            {"name": "Test Provider 6", "slug": "test-provider-6"},
        ]
    ...
    def test_update_provider(self):
        ...
        data = {"name": "Test Provider X", "slug": "test-provider-x"}
...
class CircuitTypeTest(APITestCase):
    ...
    def test_get_circuittype(self):
        ...
        url = reverse(
            "circuits-api:circuittype-detail", kwargs={"pk": self.circuittype1.pk}
        )
        response = self.client.get(url, **self.header)
    ...
    def test_create_circuittype(self):
        ...
        data = {"name": "Test Circuit Type 4", "slug": "test-circuit-type-4"}
    ...
    def test_update_circuittype(self):
        ...
        data = {"name": "Test Circuit Type X", "slug": "test-circuit-type-x"}
...
class CircuitTest(APITestCase):
    ...
    def test_list_circuits_brief(self):
        ...
        self.assertEqual(sorted(response.data["results"][0]), ["cid", "id", "url"])
...
class CircuitTerminationTest(APITestCase):
    ...
    def test_get_circuittermination(self):
        ...
        url = reverse(
            "circuits-api:circuittermination-detail",
    ...
    def test_update_circuittermination(self):
        ...
        url = reverse(
            "circuits-api:circuittermination-detail",
            kwargs={"pk": circuittermination5.pk},
        )
        response = self.client.put(url, data, format="json", **self.header)
