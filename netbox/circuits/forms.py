...
class ProviderFilterForm(BootstrapMixin, CustomFieldFilterForm):
    ...
    site = FilterChoiceField(
        ...
        to_field_name="slug",
        widget=APISelect(api_url="/api/dcim/sites/", value_field="slug"),
    )
    asn = forms.IntegerField(required=False, label="ASN")
...
class CircuitTypeCSVForm(forms.ModelForm):
    ...
    class Meta:
        ...
        help_texts = {"name": "Name of circuit type"}
...
class CircuitCSVForm(forms.ModelForm):
    ...
    status = CSVChoiceField(
        choices=CIRCUIT_STATUS_CHOICES, required=False, help_text="Operational status"
    )
...
class CircuitFilterForm(BootstrapMixin, CustomFieldFilterForm):
    ...
    type = FilterChoiceField(
        ...
        widget=APISelectMultiple(
            api_url="/api/circuits/circuit-types/", value_field="slug"
        ),
    )
    provider = FilterChoiceField(
        ...
        to_field_name="slug",
        widget=APISelectMultiple(
            api_url="/api/circuits/providers/", value_field="slug"
        ),
    )
    status = forms.MultipleChoiceField(
        choices=CIRCUIT_STATUS_CHOICES, required=False, widget=StaticSelect2Multiple()
    )
