...
class ExpandableNameField(forms.CharField):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not self.help_text:
            self.help_text = (
                "Alphanumeric ranges are supported for bulk creation.<br />"
...
class FilterTreeNodeMultipleChoiceField(
    FilterChoiceFieldMixin, TreeNodeMultipleChoiceField
):
    pass
        ...
        for field_name, field in self.fields.items():
            ...
            if isinstance(field, ChainedModelChoiceField):
                ...
                for (db_field, parent_field) in field.chains:
                    if (
                        self.is_bound
                        and parent_field in self.data
                        and self.data[parent_field]
                    ):
                ...
                if filters_dict:
                    ...
                    not self.is_bound
                    and getattr(self, "instance", None)
