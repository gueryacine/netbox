...
class TenantGroupTest(APITestCase):
    ...
    def test_get_tenantgroup(self):
        ...
        url = reverse(
            "tenancy-api:tenantgroup-detail", kwargs={"pk": self.tenantgroup1.pk}
        )
    ...
    def test_create_tenantgroup(self):
        ...
        data = {"name": "Test Tenant Group 4", "slug": "test-tenant-group-4"}
    ...
    def test_create_tenantgroup_bulk(self):
        ...
        data = [
            {"name": "Test Tenant Group 4", "slug": "test-tenant-group-4"},
            {"name": "Test Tenant Group 5", "slug": "test-tenant-group-5"},
            {"name": "Test Tenant Group 6", "slug": "test-tenant-group-6"},
        ]
    ...
    def test_update_tenantgroup(self):
        ...
        data = {"name": "Test Tenant Group X", "slug": "test-tenant-group-x"}
...
class TenantTest(APITestCase):
    ...
    def test_create_tenant_bulk(self):
        ...
        data = [
            {"name": "Test Tenant 4", "slug": "test-tenant-4"},
            {"name": "Test Tenant 5", "slug": "test-tenant-5"},
            {"name": "Test Tenant 6", "slug": "test-tenant-6"},
        ]
