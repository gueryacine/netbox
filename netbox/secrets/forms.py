...
class SecretRoleForm(BootstrapMixin, forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {"users": StaticSelect2Multiple(), "groups": StaticSelect2Multiple()}
...
class SecretRoleCSVForm(forms.ModelForm):
    ...
    class Meta:
        ...
        help_texts = {"name": "Name of secret role"}
...
class SecretCSVForm(forms.ModelForm):
    ...
    class Meta:
        ...
        help_texts = {"name": "Name or username"}
...
class SecretFilterForm(BootstrapMixin, CustomFieldFilterForm):
    ...
    role = FilterChoiceField(
        ...
        widget=APISelectMultiple(
            api_url="/api/secrets/secret-roles/", value_field="slug"
        ),
    )
