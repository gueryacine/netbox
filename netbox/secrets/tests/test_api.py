...
class SecretRoleTest(APITestCase):
    ...
    def test_get_secretrole(self):
        ...
        url = reverse(
            "secrets-api:secretrole-detail", kwargs={"pk": self.secretrole1.pk}
        )
    ...
    def test_create_secretrole(self):
        ...
        data = {"name": "Test Secret Role 4", "slug": "test-secret-role-4"}
    ...
    def test_create_secretrole_bulk(self):
        ...
        data = [
            {"name": "Test Secret Role 4", "slug": "test-secret-role-4"},
            {"name": "Test Secret Role 5", "slug": "test-secret-role-5"},
            {"name": "Test Secret Role 6", "slug": "test-secret-role-6"},
        ]
    ...
    def test_update_secretrole(self):
        ...
        data = {"name": "Test SecretRole X", "slug": "test-secretrole-x"}
